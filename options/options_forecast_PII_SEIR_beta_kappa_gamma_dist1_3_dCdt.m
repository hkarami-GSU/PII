...
cadfilename1='curve-PII-SEIR-dist1-3-dCdt'; % Name of the data file (without extension) containing the incidence curve
...
model.name='SEIR-PII-beta-kappa-gamma-dist1-3-dCdt';   % string indicating the name of the ODE model
