...
cadfilename1='curve-PII-SEIRunrep-dist1-3';

caddisease='SEIRunrep'; % string indicating the name of the disease related to the time series data
...
model.fc=@SEIRunrep1; % name of the model function
model.name='SEIRunrep1-PII-beta-rho-gamma-dist1-3';   % string indicating the name of the ODE model

params.label={'\beta_0','\kappa','\rho','\gamma','N'};  % list of symbols to refer to the model parameters
params.LB=[0.001 0.001 0 0.01 500000]; % lower bound values of the parameter estimates
params.UB=[25 5 1 5 500000]; % upper bound values of the parameter estimates
params.initial=[0.5 1/2 0.5 1/4 500000]; % initial parameter values/guesses
