...
cadfilename1='curve-PII-GGM-dist1-3'; % Name of the data file (without extension) containing the incidence curve
...
model.name='GGM-PII-r-p-dist1-3'; % string indicating the name of the ODE model
