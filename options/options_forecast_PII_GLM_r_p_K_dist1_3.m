...
cadfilename1='curve-PII-GLM-dist1-3'; % Name of the data file (without extension) containing the incidence curve
...
model.name='GLM-PII-r-p-K-dist1-3'; % string indicating the name of the ODE model
