...
cadfilename1='curve-PII-GGM-dist1-1'; % Name of the data file (without extension) containing the incidence curve

caddisease='GGM'; % string indicating the name of the disease related to the time series data
...
model.name='GGM-PII-r-p-dist1-1'; % string indicating the name of the ODE model

model.fc=@GGM;  % name of the model function
model.name='GGM'; % string indicating the name of the ODE model
...
params.initial=[0.14 0.98]; % initial parameter values/guesses
params.fixed=[0 0]; % Boolean vector to indicate any parameters that should remain fixed (1) to initial values indicated in params.initial. Otherwise the parameter is estimated (0).
