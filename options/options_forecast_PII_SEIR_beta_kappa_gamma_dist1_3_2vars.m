...
cadfilename1='curve-PII-SEIR-dist1-3-2vars'; % Name of the data file (without extension) containing the incidence curve
...
model.name='SEIR-PII-beta-kappa-gamma-dist1-3-2vars';   % string indicating the name of the ODE model
...
vars.fit_index=[3 5]; % index of the model's variable that will be fit to the observed time series data
vars.fit_diff=[0 1]; % boolean variable to indicate if the derivative of model's fitting variable should be fit to data.
