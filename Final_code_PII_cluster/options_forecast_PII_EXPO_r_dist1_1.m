...
cadfilename1='curve-PII-EXPO-dist1-1'; % Name of the data file (without extension) containing the incidence curve
...
model.name='EXP-PII-r-dist1-1'; % string indicating the name of the ODE model
