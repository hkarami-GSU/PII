...
model.name='SEIR-PII-beta-gamma-dist1-3';   % string indicating the name of the ODE model
...
params.fixed=[0 1 0 1]; % Boolean vector to indicate any parameters that should remain fixed (1) to initial values indicated in params.initial. Otherwise the parameter is estimated (0).
