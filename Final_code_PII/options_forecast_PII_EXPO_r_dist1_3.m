...
cadfilename1='curve-PII-EXPO-dist1-3'; % Name of the data file (without extension) containing the incidence curve

caddisease='EXPO'; % string indicating the name of the disease related to the time series data
...
model.name='EXP-PII-r-dist1-3'; % string indicating the name of the ODE model
...
params.UB=[1]; % upper bound values of the parameter estimates
params.initial=[0.14]; % initial parameter values/guesses
